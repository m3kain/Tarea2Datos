...
if ($view === 'articulos') {
    $stmt = $conn->query("SELECT a.id_articulo, a.titulo, GROUP_CONCAT(DISTINCT ar.titulo_area SEPARATOR ', ') AS topicos,
...
<?php if ($view === 'articulos'): ?>
    ...
    <table border="1" cellpadding="6">
        <tr>
            <th>#</th><th>Título</th><th>Autores</th><th>Tópicos</th><th>Revisores</th><th>Asignar</th><th>Quitar</th>
        </tr>
